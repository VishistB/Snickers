...
def validate(file_name):
    ...
    point2 = []
    myPoints = []
    path = os.path.join(settings.MEDIA_ROOT, 'id')
    myPic = os.listdir(path)
    imgQ = cv2.imread(os.path.join(settings.MEDIA_ROOT, file_name))
    # imgQ = cv2.imread(os.path.join(settings.MEDIA_ROOT, os.path.join(file_name[0], file_name[1])))
    
    
    print(os.path.join(settings.MEDIA_ROOT, os.path.join(file_name[0], file_name[1])))
    ...
    # final3 += [final2[10]]
    # final3 += [final2[12]]
    final3 = {'Name':final2[3],'Company':final2[0]}
